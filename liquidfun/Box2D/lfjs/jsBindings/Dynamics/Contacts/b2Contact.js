...
var b2Contact_flags_enabledFlag = 0x0004;
...
b2Contact.prototype.SetEnabled = function(flag) {
  var oldFlags = this.buffer.getUint32(b2Contact_flags_offset, true);
  if (flag)
  {
    oldFlags |= b2Contact_flags_enabledFlag;
  }
  else
  {
    oldFlags &= ~b2Contact_flags_enabledFlag;
  }
  this.buffer.setUint32(b2Contact_flags_offset, oldFlags, true);
};
